...
export default function AdminPanel() {
  ...
  const updateSystemConfig = async (field, value) => {
    try {
      const token = localStorage.getItem("token");
      const updatedConfig = {
        ...systemConfig,
      ...
      if (response.ok) {
        ...
        alert(`✅ Đã ${value ? 'BẬT' : 'TẮT'} chức năng ${field === 'enableReport' ? 'Báo cáo' : 'Phản hồi'}!`);
      } else {
    ...
    <div style={{ maxWidth: 1200, margin: "40px auto", padding: "0 20px" }}>
      ...
      <div style={{ 
        ...
        <h3 style={{ 
          ...
          ⚙️ Cấu hình hệ thống (Áp dụng cho tất cả users)
        </h3>
        <div style={{ 
          display: "grid", 
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <h4 style={{ margin: "0 0 5px 0", color: "#495057" }}>📝 Chức năng Báo cáo</h4>
              <p style={{ margin: 0, fontSize: "13px", color: "#6c757d" }}>
                Cho phép user gửi báo cáo
              </p>
            </div>
            <button
              onClick={() => updateSystemConfig('enableReport', !systemConfig.enableReport)}
              style={{
                padding: "8px 16px",
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <h4 style={{ margin: "0 0 5px 0", color: "#495057" }}>📊 Chức năng Phản hồi</h4>
              <p style={{ margin: 0, fontSize: "13px", color: "#6c757d" }}>
                Cho phép user xem trạng thái phản hồi
              </p>
            </div>
            <button
              onClick={() => updateSystemConfig('enableFeedback', !systemConfig.enableFeedback)}
              style={{
                padding: "8px 16px",
